...
export default function Hero() {
  return (
    <section id="inicio" className="relative h-[600px] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full font-black">
        {/* Main text */}
        <h1 className="text-4xl lg:text-6xl  text-white leading-tight tracking-tight text-left mt-10">
          Convertimos tu entorno
          <br />
          en un paisaje <br className="display md:hidden"/><span className=" px-2 rounded-2xl font-black bg-[#48b135]">lleno de vida.</span>
        </h1>
